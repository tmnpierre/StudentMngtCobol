    ...
    psql -d student -U cobol -c "\d+ STUDENT" -c "SELECT * FROM STUDENT;" -c "\d+ COURSE" -c "SELECT * FROM COURSE;" -c "\d+ GRADE" -c "SELECT * FROM GRADE;" > tables_description_and_content.txt
